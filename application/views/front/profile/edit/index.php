...
<section class="section-profile-cover section-shaped my-0">
      <!-- Circles background -->
      <img class="bg-image" src="<?= base_url(); ?>assets_front/assets/img/slides/slide1.jpg" style="width: 100%;">
      <!-- SVG separator -->
        ...
        <div class="card card-profile shadow mt--300">
          <div class="px-4">
            ...
            <div class="col-6">
              ...
              <!-- <div class="h6 font-weight-300"><i class="ni location_pin mr-2"></i><?=$profile->alamat?></div>
