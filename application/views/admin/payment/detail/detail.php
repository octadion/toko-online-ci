                                ...
                                <table class="table table-borderless table-striped">
                                    ...
                                    <?php foreach($payment as $pay){?>
                                        <tr>
                                            ...
                                            <td>
                                                <?=indo_currency($pay->gross_amount)?>
                                            </td>
                                            <td class="text-center"><?=$pay->payment_type?></td>
                                            <td class="text-center font-w600"><?=$pay->vendor_name?></td>
                                            <td class="text-right"><?=$pay->va_number?></td>
                                            <td class="text-right"><?=$pay->biller_code?></td>
                                            <td class="text-right"><a href="<?=$pay->pdf_url?>" class="btn btn-sm btn-primary">PDF</a></button> </td>
                                        </tr>
                                        <?php }?>
